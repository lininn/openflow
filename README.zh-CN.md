...
> 详细图表：[架构图 (SVG)](https://unpkg.com/@lininn/openflow@0.4.0-beta.3/openflow-architecture.svg) | [架构图 (PNG)](https://unpkg.com/@lininn/openflow@0.4.0-beta.3/openflow-architecture.png) | [流程图 (SVG)](https://unpkg.com/@lininn/openflow@0.4.0-beta.3/openflow-workflow.svg) | [流程图 (PNG)](https://unpkg.com/@lininn/openflow@0.4.0-beta.3/openflow-workflow.png)

![OpenFlow 工作流](https://unpkg.com/@lininn/openflow@0.4.0-beta.3/openflow-workflow.svg)
